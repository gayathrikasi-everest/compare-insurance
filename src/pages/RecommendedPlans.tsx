...
const RecommendedPlans: React.FC = () => {
  ...
  return <div className="h-screen flex bg-white overflow-hidden">
          ...
          <div className="md:w-[35%] flex flex-col justify-between pr-4">
            <div className="flex-grow flex flex-col justify-between">
              ...
              <div className="mb-6 mt-4">
                <Button variant="outline" onClick={handleRegenerateOptions} className="text-cc-blue border-cc-blue hover:bg-cc-light-blue backdrop-blur-md flex items-center gap-2 w-full">
                  <RefreshCw size={16} />
