...
const UnderstandingYou: React.FC = () => {
  ...
  return <div className="min-h-[calc(100vh-65px)] flex items-center justify-center bg-gradient-to-br from-white to-cc-light-green animate-fade-in">
      <div className="w-full max-w-2xl p-8">
        ...
        <Button onClick={handleSubmit} disabled={query.trim() === '' || isSubmitting} className="w-full bg-gradient-to-r from-cc-green to-cc-dark-green hover:opacity-90 text-white py-6 text-lg font-medium shadow-md flex items-center justify-center">
