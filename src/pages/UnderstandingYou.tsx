        ...
        <div className="w-full max-w-2xl p-4 md:p-8">
          <div className="text-center mb-8">
            <img 
              ...
              src="/lovable-uploads/ba50f7a2-cf55-4430-91c6-39b46030b83e.png" 
            />
          ...
          <Button 
            ...
            className="w-full glass-card bg-gradient-to-r from-cc-green to-cc-dark-green hover:opacity-90 text-white py-6 text-lg font-medium shadow-md flex items-center justify-center border-none"
          >
