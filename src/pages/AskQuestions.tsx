        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex flex-wrap gap-4 mb-8">
            {mockInsurancePlans.map(plan => (
              <div key={plan.id} className="glass-card p-4 flex-1 min-w-[200px]">
                ...
                <div className="flex items-center justify-between mt-2">
                  ...
                  <Button 
                    ...
                    className="bg-cc-green hover:bg-cc-dark-green text-white text-xs py-1 px-3 h-auto"
                  >
                    Buy
                  </Button>
                </div>
          ...
          {/* Chat section */}
          <div className="glass-card mb-4 overflow-hidden flex flex-col" style={{ height: 'calc(100vh - 300px)' }}>
            {/* Chat messages */}
