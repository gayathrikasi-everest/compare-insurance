...
const Index = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-white to-blue-50 p-4 md:p-8">
      <div className="w-full max-w-5xl flex flex-col items-center">
        {/* Insurance Illustration */}
        <div className="mb-8">
          <img 
            src="/lovable-uploads/b17bc7c5-e3ca-44a3-a466-02d9c08a1a6e.png" 
        ...
        {/* Action Button */}
        <Button 
          onClick={() => navigate('/understanding-you')} 
          className="bg-cc-green hover:opacity-90 text-white px-8 py-6 text-lg rounded-xl shadow-lg mb-16"
        >
            ...
            return (
              <div key={index} className="relative flex flex-col items-center text-center">
                ...
                <div className={`flex items-center justify-center w-14 h-14 rounded-full text-lg font-semibold 
                  ${step.active ? "bg-cc-green text-white" : "bg-gray-100 text-gray-500"}`}
                >
                  {step.number}
                </div>
                ...
                {/* Connecting Arrow */}
                {!isLast && (
                  <div className="absolute top-7 left-full w-20 h-0.5 bg-gray-200 -z-10 transform translate-x-1">
