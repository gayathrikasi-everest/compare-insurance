    ...
    <div className="min-h-screen flex flex-col md:flex-row items-center justify-center bg-gradient-to-br from-white to-blue-50 p-4 md:p-8">
      <div className="w-full md:w-1/2 max-w-xl">
        ...
        <Button 
          ...
          className="w-full md:w-auto bg-gradient-to-r from-cc-green to-cc-green/80 hover:opacity-90 text-white px-8 py-6 text-lg rounded-xl shadow-lg backdrop-blur-sm border border-white/20"
        >
